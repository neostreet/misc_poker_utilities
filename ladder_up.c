...
static char usage[] =
"usage: ladder_up (-debug) (-verbose) player_name filename\n";
...
int main(int argc,char **argv)
{
  ...
  int last_table_chip_count_total;
  int final_place;
  int place;
  ...
  for ( ; ; ) {
    ...
    if ((file_no > 1) && (table_chip_counts[MAX_TABLE_PLAYERS].count != last_table_chip_count_total))
      break;
    ...
    last_table_chip_count_total = table_chip_counts[MAX_TABLE_PLAYERS].count;
  }
