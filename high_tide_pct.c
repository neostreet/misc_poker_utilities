...
static char usage[] =
"usage: high_tide_pct (-verbose) (-heads_up) player_name filename\n";
...
int main(int argc,char **argv)
{
  ...
  int my_chips;
  int high_tide_pct_num;
  int high_tide_pct_denom;
  double high_tide_pct;
  int num_files;
  int dbg_num_files;
  int dbg;
  FILE *fptr;
  ...
  if (high_tide_pct_denom) {
    ...
    if (!bVerbose)
      ...
      printf("%lf (%d %d) %s\n",high_tide_pct,
        high_tide_pct_num,high_tide_pct_denom,save_dir);
    }
  }
