...
static char usage[] =
"usage: session_cumulative_avg (-debug) (-no_sort) (-ascending) filename\n";
...
int main(int argc,char **argv)
{
  ...
  for (n = 0; n < set_size; n++) {
    printf("%10.2lf ",session_info[sort_ixs[n]].avg);
    ...
    if (bDebug) {
      printf(" %10d %6d\n",
        ...
        session_info[sort_ixs[n]].num_sessions);
    }
    else
      printf("\n");
  }
