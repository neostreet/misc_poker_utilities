...
static char usage[] =
"usage: max_underwater_length (-no_sort) (-ascending) filename\n";
...
int elem_compare(const void *elem1,const void *elem2)
{
  ...
  if (session_info[ix1].max_underwater_length == session_info[ix2].max_underwater_length)
    return session_info[ix2].end_date - session_info[ix1].end_date;

  if (bAscending)
    return session_info[ix1].max_underwater_length - session_info[ix2].max_underwater_length;
  else
    return session_info[ix2].max_underwater_length - session_info[ix1].max_underwater_length;
}
